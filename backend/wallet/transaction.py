...
# -*- coding: utf-8 -*-
"""
Created on Wed May 19 17:00:12 2021
...
class Transaction:
    ...
    def from_json(transaction_json):
        ...
        """
        '''
        return Transaction(id=transaction_json['id'], 
                           output=transaction_json['output'], 
                           input = transaction_json['input'])
        '''
        
        return Transaction(**transaction_json) #unpacks the json 
...
def main():
    ...
    print(f'\nrestored_transaction.__dict__: {transaction.__dict__}')
